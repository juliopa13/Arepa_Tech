...
from controllers.reporte_factura import  generar_pdf_bp
...
app = Flask(__name__)
CORS(app,resources={
    r"/api/dian/*": {"origins": "http://localhost:5173"},
    r"/api/ia/*": {"origins": "http://localhost:5173"},
    r"/api/pdf/*": {"origins": "http://localhost:5173"}})
